...
export const Card = ( { digimon }: IDigiData) => {
  ...
  return (
    <figure id={`${name}`}
      ...
      className="relative bg-yellow-700/90 w-52 h-80 grid grid-rows-[auto,auto,auto] place-items-center border-2 border-black rounded-md duration-200 hover:-translate-y-4 hover:z-10">
